"""
Unit tests for the Hindi telephone grammars (TN and ITN).
"""
...
class TestTelephone:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "telephone"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "telephone"))
