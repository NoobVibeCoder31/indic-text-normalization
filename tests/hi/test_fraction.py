"""
Unit tests for the Hindi fraction grammars (TN and ITN).
"""
...
class TestFraction:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "fraction"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "fraction"))
