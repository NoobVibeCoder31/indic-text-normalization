"""
Unit tests for the Hindi cardinal grammars (TN and ITN).
"""
...
class TestCardinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "cardinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "cardinal"))
