"""
Unit tests for the Hindi decimal grammars (TN and ITN).
"""
...
class TestDecimal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "decimal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "decimal"))
