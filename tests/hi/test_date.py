"""
Unit tests for the Hindi date grammars (TN and ITN).
"""
...
class TestDate:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "date"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "date"))
