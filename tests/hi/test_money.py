"""
Unit tests for the Hindi money grammars (TN and ITN).
"""
...
class TestMoney:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "money"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "money"))
