"""
Unit tests for the Hindi ordinal grammars (TN and ITN).
"""
...
class TestOrdinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "ordinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "ordinal"))
