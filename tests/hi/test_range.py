"""
Unit tests for the Hindi range grammars (TN and ITN).
"""
...
class TestRange:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "tn", "range"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("hi", "itn", "range"))
