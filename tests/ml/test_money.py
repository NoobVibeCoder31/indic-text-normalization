"""
Unit tests for the Malayalam money grammars (TN and ITN).
"""
...
class TestMoney:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "money"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "money"))
