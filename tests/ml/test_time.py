"""
Unit tests for the Malayalam time grammars (TN and ITN).
"""
...
class TestTime:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "time"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "time"))
