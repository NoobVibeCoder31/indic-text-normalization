"""
Unit tests for the Malayalam word grammars (TN and ITN).
"""
...
class TestWord:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "word"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "word"))
