"""
Unit tests for the Malayalam date grammars (TN and ITN).
"""
...
class TestDate:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "date"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "date"))
