"""
Unit tests for the Malayalam measure grammars (TN and ITN).
"""
...
class TestMeasure:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "measure"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "measure"))
