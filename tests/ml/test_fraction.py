"""
Unit tests for the Malayalam fraction grammars (TN and ITN).
"""
...
class TestFraction:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "fraction"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "fraction"))
