"""
Unit tests for the Malayalam whitelist grammars (TN and ITN).
"""
...
class TestWhitelist:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "whitelist"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "whitelist"))
