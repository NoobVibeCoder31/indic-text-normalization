"""
Unit tests for the Malayalam range grammars (TN and ITN).
"""
...
class TestRange:
    """
    Golden-file tests for the range semiotic class.
    """

    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "tn", "range"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ml", "itn", "range"))
