"""
Unit tests for the Tamil decimal grammars (TN and ITN).
"""
...
class TestDecimal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "decimal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "decimal"))
