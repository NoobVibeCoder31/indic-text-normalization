"""
Unit tests for the Tamil ordinal grammars (TN and ITN).
"""
...
class TestOrdinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "ordinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "ordinal"))
