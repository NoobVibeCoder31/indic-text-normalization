"""
Unit tests for the Tamil word grammars (TN and ITN).
"""
...
class TestWord:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "word"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "word"))
