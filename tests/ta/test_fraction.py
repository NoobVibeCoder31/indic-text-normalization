"""
Unit tests for the Tamil fraction grammars (TN and ITN).
"""
...
class TestFraction:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "fraction"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "fraction"))
