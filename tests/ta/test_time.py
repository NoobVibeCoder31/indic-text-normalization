"""
Unit tests for the Tamil time grammars (TN and ITN).
"""
...
class TestTime:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "time"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "time"))
