"""
Unit tests for the Tamil telephone grammars (TN and ITN).
"""
...
class TestTelephone:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "telephone"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "telephone"))
