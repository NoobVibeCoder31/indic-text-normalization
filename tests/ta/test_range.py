"""
Unit tests for the Tamil range grammars (TN and ITN).
"""
...
class TestRange:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "range"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "range"))
