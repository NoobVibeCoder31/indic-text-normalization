"""
Unit tests for the Tamil cardinal grammars (TN and ITN).
"""
...
class TestCardinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "cardinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "cardinal"))
