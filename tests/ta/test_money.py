"""
Unit tests for the Tamil money grammars (TN and ITN).
"""
...
class TestMoney:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "tn", "money"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("ta", "itn", "money"))
