"""
Unit tests for the Telugu ordinal grammars (TN and ITN).
"""
...
class TestOrdinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "ordinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "ordinal"))
