"""
Unit tests for the Telugu measure grammars (TN and ITN).
"""
...
class TestMeasure:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "measure"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "measure"))
