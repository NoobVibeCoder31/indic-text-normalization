"""
Unit tests for the Telugu cardinal grammars (TN and ITN).
"""
...
class TestCardinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "cardinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "cardinal"))
