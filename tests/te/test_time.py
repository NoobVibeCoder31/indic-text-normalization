"""
Unit tests for the Telugu time grammars (TN and ITN).
"""
...
class TestTime:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "time"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "time"))
