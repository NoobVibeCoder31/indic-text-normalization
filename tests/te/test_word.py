"""
Unit tests for the Telugu word grammars (TN and ITN).
"""
...
class TestWord:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "word"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "word"))
