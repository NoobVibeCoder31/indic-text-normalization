"""
Unit tests for the Telugu range grammars (TN and ITN).
"""
...
class TestRange:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "tn", "range"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("te", "itn", "range"))
