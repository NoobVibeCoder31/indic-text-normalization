"""
Unit tests for the Kannada time grammars (TN and ITN).
"""
...
class TestTime:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "time"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "time"))
