"""
Unit tests for the Kannada whitelist grammars (TN and ITN).
"""
...
class TestWhitelist:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "whitelist"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "whitelist"))
