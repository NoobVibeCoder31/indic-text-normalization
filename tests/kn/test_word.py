"""
Unit tests for the Kannada word grammars (TN and ITN).
"""
...
class TestWord:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "word"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "word"))
