"""
Unit tests for the Kannada range grammars (TN and ITN).
"""
...
class TestRange:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "range"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "range"))
