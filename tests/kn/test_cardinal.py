"""
Unit tests for the Kannada cardinal grammars (TN and ITN).
"""
...
class TestCardinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "cardinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "cardinal"))
