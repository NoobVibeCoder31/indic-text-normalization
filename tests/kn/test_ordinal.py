"""
Unit tests for the Kannada ordinal grammars (TN and ITN).
"""
...
class TestOrdinal:
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "tn", "ordinal"))
    ...
    @pytest.mark.parametrize(("text", "expected"), load_golden("kn", "itn", "ordinal"))
