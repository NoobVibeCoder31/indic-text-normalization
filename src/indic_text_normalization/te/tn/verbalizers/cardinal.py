...
from indic_text_normalization.te.constants import MINUS_WORD, NOT_QUOTE, GraphFst, delete_space


class CardinalFst(GraphFst):
    """
    Finite state transducer for verbalizing cardinal, e.g.
        cardinal { negative: "true" integer: "ఇరవై మూడు" } -> ఋణ ఇరవై మూడు
    """
    ...
    def __init__(self, deterministic: bool = True):
        ...
        integer = pynini.closure(NOT_QUOTE)
