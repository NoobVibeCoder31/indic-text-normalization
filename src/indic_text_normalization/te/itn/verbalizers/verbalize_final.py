"""
Sentence-level Telugu ITN verbalizer.
"""
...
from indic_text_normalization.te.itn.verbalizers.word import WordFst


class VerbalizeFinalFst(GraphFst):
    """
    Finite state transducer that verbalizes an entire tagged ITN sentence, e.g.
    tokens { cardinal { integer: "23" } } tokens { name: "మంది" } -> 23 మంది
    """
