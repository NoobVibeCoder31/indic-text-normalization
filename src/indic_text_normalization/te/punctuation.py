"""
Punctuation tagger shared by the Telugu TN and ITN grammars.
"""
...
class PunctuationFst(GraphFst):
    ...
    def __init__(self, *, speak_equals: bool = False, deterministic: bool = True) -> None:
        super().__init__(name="punctuation", kind="classify", deterministic=deterministic)

        self.punct_marks = PUNCT_UNICODE + list(_ASCII_MARKS)
