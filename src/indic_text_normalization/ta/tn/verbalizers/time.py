...
class TimeFst(GraphFst):
    ...
    def __init__(self) -> None:
        ...
        hour = pynutil.delete('hours: "') + pynini.closure(NOT_QUOTE, 1) + pynutil.delete('"')
        minute = pynutil.delete('minutes: "') + pynini.closure(NOT_QUOTE, 1) + pynutil.delete('"')
        second = pynutil.delete('seconds: "') + pynini.closure(NOT_QUOTE, 1) + pynutil.delete('"')
